...
public class AutoBalance extends ProfiledPIDCommand {
  ...
  public AutoBalance(Swerve swerve) {
    ...
    getController()
      .setTolerance(Constants.kBalanceToleranceDeg, Constants.kTurnRateToleranceDegPerS);
    }
  ...
  public void initialize() {
    ...
    if (swerve.gyro.getPitch() < Constants.kBalanceToleranceDeg) {
      System.out.println(
        "Starting assumption not met: Roll is " + swerve.gyro.getPitch() +
        " Tolerance is " + Constants.kBalanceToleranceDeg);
    }
  }
