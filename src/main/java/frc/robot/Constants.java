...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double angleKF = 0.00156;

        /* Drive Motor PID Values */
        public static final double driveKP = 0.08;
        public static final double driveKI = 0.0;
        public static final double driveKD = 0.0;
        public static final double driveKF = 0.00156;
        ...
        public static final class Mod0 {
            ...
            public static final double angleOffset = 139.5;
        ...
        public static final class Mod3 {
            ...
            public static final double angleOffset = 115;
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
